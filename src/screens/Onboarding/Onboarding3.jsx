  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('../../../assets/onboarding/w3.png')}
      ...
      <View style={styles.contentContainer}>
        <View style={styles.textContainer}>
          ...
          <Text style={styles.title}>
            Get Personalized{'\n'}
            <Text style={styles.titleOrange}>Mental Health</Text> Insights
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  imageContainer: {
    ...
    alignItems: 'center',
    backgroundColor: '#FFD2C2', // Match container background
  },
  backgroundImage: {
    width: '100%',
    height: '100%',
